  ...
  return (
    <main className="main">
      <div role="tablist" className="tabs tabs-lifted">
        ...
        >
          {" "}
          <div className=" font-bold text-2xl  mb-5">Airplane Dasboard</div>
          <div className="p-5 bg-base-200 rounded-2xl mb-5">
            <div className="bg-white p-5 rounded-2xl"></div>
          </div>
          <div className="font-bold text-2xl mb-5">
            Airplane Management Table
          </div>
          <div className="p-5 bg-base-200 rounded-2xl shadow">
            <div className="bg-white p-5 rounded-2xl drop-shadow-lg">
              <AirplaneTable />
            </div>
          </div>
        </div>
